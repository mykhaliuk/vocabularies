...
- **Hanken Grotesk** — UI + body (warm humanist grotesque)
...
1. Download the `.woff2` files for both families (weights used: Hanken Grotesk 400/500/600/700/800 + italic 400/500; Newsreader 400/500/600 + italic 400/500).
